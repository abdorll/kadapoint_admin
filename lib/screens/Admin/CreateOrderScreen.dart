...
class CreateOrderScreenState extends State<CreateOrderScreen> {
  ...
  List<CountryData> stateList = [];
  List<RegionData> cityList = [];
  ...
  void init() async {
    ...
    await getPackageTypeListApiCall();
  ...
  getCountryApiCall() async {
    ...
    await getCountryList().then((value) {
      ...
      selectedCountry = stateList[0].id!;
      getCityApiCall();
      setState(() {});
    }).catchError((error) {
      appStore.setLoading(false);
  ...
  getCityApiCall({String? name}) async {
    appStore.setLoading(true);
    await getCityList(stateId: selectedCountry!).then((value) {
      appStore.setLoading(false);
      cityList.clear();
  ...
  String getCountryCode() {
    String stateCode = stateList[0].code!;
  ...
  getTotalAmount() {
    ...
    if (double.tryParse(weightController.text)! > cityData!.minWeight!) {
      weightCharge = double.parse(
          ((double.tryParse(weightController.text)! - cityData!.minWeight!) *
    ...
    totalAmount = double.parse(
        (totalAmount + totalExtraCharge).toStringAsFixed(digitAfterDecimal));
  }
  ...
  createOrderApiCall(String orderStatus) async {
    Map req = {
      ...
      "total_package": int.tryParse(totalPackageController.text),
    };
    appStore.setLoading(true);
          ...
          if (_formKey.currentState!.validate()) {
            ...
            if (!isDeliverNow) {
              pickFromDateTime = pickDate!.add(Duration(
                  hours: pickFromTime!.hour, minutes: pickFromTime!.minute));
              pickToDateTime = pickDate!.add(Duration(
                  hours: pickToTime!.hour, minutes: pickToTime!.minute));
              ...
              deliverToDateTime = deliverDate!.add(Duration(
                  hours: deliverToTime!.hour, minutes: deliverToTime!.minute));
            ...
            if (differenceCurrentTime.inMinutes > 0)
              return toast(language.pickup_current_validation_msg);
                    ...
                    Padding(
                      ...
                      child: ResponsiveWidget.isSmallScreen(context)
                          ...
                          : Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Expanded(child: pickTimeWidget()),
                                SizedBox(width: 16),
                                Expanded(child: deliverTimeWidget())
                              ],
                            ),
                    ),
                  SizedBox(height: 16),
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsets.all(12.0),
                                  child: Text(language.number_of_packages,
                                      style: primaryTextStyle()),
                                ),
                              ),
                              VerticalDivider(thickness: 1),
                              GestureDetector(
                                ...
                                onTap: () {
                                  if (int.parse(totalPackageController.text) >
                                      1) {
                                    totalPackageController.text = (int.parse(
                              ...
                              GestureDetector(
                                ...
                                onTap: () {
                                  totalPackageController.text =
                                      (int.parse(totalPackageController.text) +
                                              1)
                                          .toString();
                                },
                              ),
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(language.state, style: boldTextStyle()),
                            SizedBox(height: 8),
                            DropdownButtonFormField<int>(
                              ...
                              style: primaryTextStyle(),
                              items:
                                  stateList.map<DropdownMenuItem<int>>((item) {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<int>(
                              ...
                              style: primaryTextStyle(),
                              items:
                                  cityList.map<DropdownMenuItem<int>>((item) {
                                return DropdownMenuItem(
                                  value: item.id,
                                  child: Text(item.name ?? ''),
                                );
                    ...
                    children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 16),
                                  Text(language.pickup_description,
                                      style: primaryTextStyle()),
                                  SizedBox(height: 8),
                                  TextField(
                      ...
                      SizedBox(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(language.delivery_information,
                                style: boldTextStyle()),
                            SizedBox(height: 8),
                            Container(
                              padding: EdgeInsets.all(16),
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(language.delivery_location,
                                      style: primaryTextStyle()),
                                  SizedBox(height: 8),
                                  AppTextField(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(language.payment_collect_form,
                                style: boldTextStyle()),
                            SizedBox(height: 8),
