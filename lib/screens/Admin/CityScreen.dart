...
class CityScreenState extends State<CityScreen> {
  ...
  getCityListApiCall() async {
    ...
    await getCityList(page: currentPage, isDeleted: true, perPage: perPage)
        .then((value) {
  ...
  updateStatusApiCall(RegionData regionData) async {
    Map req = {
      "id": regionData.id,
      "status": regionData.status == 1 ? 0 : 1,
    };
    appStore.setLoading(true);
                                                  ...
                                                  mData.deletedAt == null
                                                      ...
                                                      : commonConfirmationDialog(
                                                          ...
                                                          title: language
                                                              .restore_city,
                                                          subtitle: language
                                                              .do_you_want_to_restore_this_city);
                                                }),
                                                SizedBox(width: 8),
                                                outlineActionIcon(
                                                    mData.deletedAt == null
                                                    ...
                                                    if (getStringAsync(
                                                      ...
                                                      isForceDelete:
                                                          mData.deletedAt !=
                                                              null,
                                                      title:
                                                          language.delete_city,
                                                      subtitle: language
                                                          .do_you_want_to_delete_this_city);
                                                }),
                                                SizedBox(width: 8),
                                                outlineActionIcon(
                                                    Icons.visibility,
