...
class DeliveryPersonDetailScreen extends StatefulWidget {
  ...
  @override
  _DeliveryPersonDetailScreenState createState() =>
      _DeliveryPersonDetailScreenState();
}

class _DeliveryPersonDetailScreenState
    extends State<DeliveryPersonDetailScreen> {
  ...
  commonWidget({String? title, var value}) {
    return Container(
      decoration: boxDecorationWithRoundedCorners(
          ...
          border: Border.all(width: 0.9, color: context.dividerColor),
  ...
  actionWidget() {
    return Wrap(
      ...
      children: [
        ...
        outlineActionIcon(
            userData!.deletedAt == null ? Icons.edit : Icons.restore,
            Colors.green,
            '${userData!.deletedAt == null ? language.edit : language.restore}',
            () {
                  ...
                  if (sharedPref.getString(USER_TYPE) == DEMO_ADMIN) {
                    ...
                    if (userData!.userType == CLIENT)
                      ...
                      restoreDeliveryBoyApiCall(
                          id: userData!.id, type: RESTORE);
                  }
                },
                  title: userData!.userType == CLIENT
                      ? language.restore_user
                      : language.restore_delivery_person,
                  subtitle: userData!.userType == CLIENT
                      ? language.restore_user_msg
                      : language.restore_delivery_person_msg);
        },
        ...
        outlineActionIcon(
          ...
          commonConfirmationDialog(context, DIALOG_TYPE_DELETE, () {
            if (sharedPref.getString(USER_TYPE) == DEMO_ADMIN) {
              ...
              if (userData!.userType == CLIENT)
                userData!.deletedAt == null
                    ? deleteUserApiCall(userData!.id!)
                    : restoreUserApiCall(id: userData!.id, type: FORCE_DELETE);
              else {
                userData!.deletedAt == null
                    ? deleteDeliveryBoyApiCall(userData!.id!)
                    : restoreDeliveryBoyApiCall(
                        id: userData!.id, type: FORCE_DELETE);
              }
            }
          },
              ...
              title: userData!.userType == CLIENT
                  ...
                  : language.delete_delivery_person,
              subtitle: userData!.userType == CLIENT
                  ? language.delete_user_msg
                  : language.delete_delivery_person_msg);
        },
            title: ResponsiveWidget.isLargeScreen(context) ||
                    ResponsiveWidget.isMediumScreen(context)
                ? '${userData!.deletedAt == null ? language.delete : language.force_delete}'
                  ...
                  children: [
                        ...
                        if (userData != null)
                          Container(
                            ...
                            decoration: boxDecorationWithRoundedCorners(
                                backgroundColor: context.cardColor,
                                border: Border.all(
                                    width: 0.9, color: context.dividerColor),
                                borderRadius: radius(defaultRadius)),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    if (userData!.userType == DELIVERYMAN &&
                                      ...
                                      outlineActionIcon(Icons.location_on,
                                          primaryColor, language.location, () {
                                        if (userData!.latitude != null &&
                                            userData!.longitude != null) {
                                          MapsLauncher.launchCoordinates(
                                              double.parse(userData!.latitude!),
                                              double.parse(
                                                  userData!.longitude!));
                                        } else {
                                        ...
                                        commonConfirmationDialog(
                                          ...
                                          if (sharedPref.getString(USER_TYPE) ==
                                            ...
                                            title: userData!.userType ==
                                                ...
                                                ? userData!.status != 1
                                                    ? language
                                                        .enable_delivery_person
                                                    : language
                                                        .disable_delivery_person
                                                : userData!.status != 1
                                                    ? language.enable_user
                                                    : language.disable_user,
                                            subtitle: userData!.userType ==
                                                    DELIVERYMAN
                                                ? userData!.status != 1
                                                    ? language
                                                        .do_you_want_to_enable_this_delivery_person
                                                    : language
                                                        .do_you_want_to_disable_this_delivery_person
                                                : userData!.status != 1
                                                    ? language
                                                        .do_you_want_to_enable_this_user
                                                    : language
                                                        .do_you_want_to_disable_this_user);
                                      },
                                    ),
                                    if (userData!.userType == DELIVERYMAN)
                                ...
                                16.height,
                                commonDetailWidget(
                                    icon: Icons.mail, title: userData!.email),
                                16.height,
                                commonDetailWidget(
                                    icon: Icons.phone,
                                    title: userData!.contactNumber),
                                ...
                                if (userData!.cityName != null ||
                                  ...
                                  commonDetailWidget(
                                      icon: Icons.map,
                                      title: userData!.cityName.validate() +
                                          ',' +
                                          userData!.stateName.validate())
                              ],
                            ),
                          ),
                        SizedBox(
                              ...
                              children: [
                                      ...
                                      children: [
                                        ...
                                        Wrap(
                                          ...
                                          children: [
                                            ...
                                            commonBankWidget(
                                                title:
                                                    language.accountHolderName,
                                                value: userData!
                                                    .userBankAccount!
                                                    .accountHolderName
                                                    .validate()),
                                            commonBankWidget(
                                                title: language.accountNumber,
                                                value: userData!
                                                    .userBankAccount!
                                                    .accountNumber
                                                    .validate()),
                                            commonBankWidget(
                                                title: language.ifscCode,
                                                value: userData!
                                ...
                                if (userData!.userType == DELIVERYMAN &&
                                  ...
                                  Wrap(
                                    ...
                                    children: [
                                      commonWidget(
                                          title: language.walletTotalBalance,
                                          value: printAmount(
                                              earningDetail!.walletBalance ??
                                                  0)),
                                      commonWidget(
                                          title: language.totalWithdrawal,
                                          value: printAmount(
                                              earningDetail!.totalWithdrawn ??
                                                  0)),
                                      commonWidget(
                                          title: language.adminCommission,
                                          value: printAmount(
                                              earningDetail!.adminCommission ??
                                                  0)),
                                      commonWidget(
                                          title: language.commission,
                                          value: printAmount(earningDetail!
                                                  .deliveryManCommission ??
                                              0)),
                                      commonWidget(
                                          title: language.total_order,
                                          value: earningDetail!.totalOrder
                                              .toString()
                                              .validate(value: '0')),
                                      commonWidget(
                                          title: language.paidOrder,
                                          value: earningDetail!.paidOrder
                                              .toString()
                                              .validate(value: '0')),
                                    ],
                                  ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            if (walletHistory!
                                                    ...
                                                    .toInt() >
                                                walletHistory!.pagination!.perPage!
                                                    .toInt())
                                              paginationWidget(context,
                                                  isPerpage: false,
                                                  currentPage: walletHistory!
                                                      .pagination!.currentPage!,
                                                  totalPage: walletHistory!
                                                      .pagination!.totalPages!,
                                                  perPage: walletHistory!
                                                      .pagination!.perPage!,
                                                  onUpdate: (currentPageVal,
                                                      perPageVal) {
                                                getWalletHistory(
                                                    currentPageVal);
                                                setState(() {});
                    ...
                    if (userData!.userType == DELIVERYMAN)
                      Wrap(
                        ...
                        children: [
                          walletHistory != null &&
                                  walletHistory!.walletDataModel!.isNotEmpty
                              ? Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (walletHistory!.pagination!.totalItems!
                                              .toInt() >
                                          walletHistory!.pagination!.perPage!
                                              .toInt())
                                        paginationWidget(context,
                              ...
                              : SizedBox(),
                          earningList != null &&
                                  earningList!.earningDataModel!.isNotEmpty
                              ? Container(
                                  width: getTableWidth(context),
                                  child: Column(
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      if (earningList!.pagination!.totalItems!
                                              .toInt() >
                                          earningList!.pagination!.perPage!
                                              .toInt())
                                        paginationWidget(context,
                                            isPerpage: false,
                                            currentPage: earningList!
                                                .pagination!.currentPage!,
                                            totalPage: earningList!
                                                .pagination!.totalPages!,
                                            perPage: earningList!
                                                .pagination!.perPage!,
                                            onUpdate:
