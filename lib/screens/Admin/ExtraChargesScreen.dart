...
class ExtraChargesScreenState extends State<ExtraChargesScreen> {
  ...
  getExtraChargeListApiCall() async {
    ...
    await getExtraChargeList(
            page: currentPage, isDeleted: true, perPage: perPage)
        .then((value) {
                                  ...
                                  child: ConstrainedBox(
                                    ...
                                    child: DataTable(
                                        ...
                                        columns: [
                                          ...
                                          DataColumn(
                                              label: Text(language.city_name)),
                                          DataColumn(
                                              label: Text(language.charge)),
                                          DataColumn(
                                        ...
                                        rows: extraChargeList.map((mData) {
                                          return DataRow(cells: [
                                            ...
                                            DataCell(Text(
                                                '${mData.cityName ?? "-"}')),
                                            DataCell(Text(
                                                '${mData.charges} ${mData.chargesType == CHARGE_TYPE_PERCENTAGE ? '%' : ''}')),
                                            DataCell(Text(
                                                    ...
                                                    ? commonConfirmationDialog(
                                                        ...
                                                        title: mData.status != 1
                                                            ? language
                                                                .enable_extra_charge
                                                            : language
                                                                .disable_extra_charge,
                                                        subtitle: mData
                                                                    .status !=
                                                                1
                                                            ? language
                                                                .enable_extra_charge_msg
                                                            : language
                                                                .disable_extra_charge_msg)
                                                    : toast(language
                                                  ...
                                                  outlineActionIcon(
                                                    ...
                                                    mData.deletedAt == null
                                                        ...
                                                        : commonConfirmationDialog(
                                                            ...
                                                            title: language
                                                                .restore_extraCharges,
                                                            subtitle: language
                                                                .do_you_want_to_restore_this_extra_charges);
                                                  }),
                                                  SizedBox(width: 8),
                                                  outlineActionIcon(
                                                      mData.deletedAt == null
                                                      ...
                                                      if (getStringAsync(
                                                        ...
                                                        isForceDelete:
                                                            mData.deletedAt !=
                                                                null,
                                                        title: language
                                                            .delete_extra_charges,
                                                        subtitle: language
                                                            .do_you_want_to_delete_this_extra_charges);
                                                  }),
                                                ],
                                              ),
                                            ),
