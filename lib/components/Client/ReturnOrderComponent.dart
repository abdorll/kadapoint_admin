...
class ReturnOrderComponentState extends State<ReturnOrderComponent> {
  ...
  createOrderApiCall() async {
    if (formKey.currentState!.validate()) {
      ...
      if (!isDeliverNow) {
        DateTime pickFromDateTime = pickDate!.add(
            Duration(hours: pickFromTime!.hour, minutes: pickFromTime!.minute));
        DateTime pickToDateTime = pickDate!.add(
            Duration(hours: pickToTime!.hour, minutes: pickToTime!.minute));
        DateTime deliverFromDateTime = deliverDate!.add(Duration(
            hours: deliverFromTime!.hour, minutes: deliverFromTime!.minute));
        DateTime deliverToDateTime = deliverDate!.add(Duration(
        ...
        widget.orderData.pickupPoint!.startTime =
      ...
      Map req = {
        ...
        "country_id": widget.orderData.stateId!,
        ...
        "package_type": widget.orderData.packageType!,
        ...
        "reason": reason!.validate().trim() != 'Other'
            ? reason
      ...
      await createOrder(req).then((value) {
        ...
        if (isSelected == 2) {
          log("-----" +
              ...
              widget.orderData.totalAmount.toString());
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(language.returnOrder,
                              style:
                                  boldTextStyle(size: 20, color: primaryColor)),
                          16.width,
                          IconButton(
                              onPressed: () {
                                  ...
                                  children: [
                                    ...
                                    DateTimePicker(
                                      ...
                                      validator: (value) {
                                        ...
                                        double toTimeInHour = pickToTime!.hour +
                                            pickToTime!.minute / 60;
                                        double difference =
                                            toTimeInHour - fromTimeInHour;
                                        print(difference);
                                        if (difference <= 0) {
                                          return language
                                              .end_start_time_validation_msg;
                                        }
                                        return null;
                                      },
                                      decoration: commonInputDecoration(
                      ...
                      AppTextField(
                        ...
                        decoration: commonInputDecoration(
                            hintText: language.writeHereReason),
                        maxLines: 3,
                        minLines: 3,
                        validator: (value) {
                          if (value!.isEmpty)
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          16.width,
                          Text(
                              '${printAmount(widget.orderData.totalAmount ?? 0)}',
                              style: boldTextStyle(size: 20)),
                        ],
                      ),
                      30.height,
                      appButton(context, title: language.saveChanges,
                          onCall: () {
                        createOrderApiCall();
                      }),
                      16.height,
