          ...
          authServices
            ...
            if (v.data!.userType != CLIENT) {
              ...
              if (getIntAsync(USER_STATUS) == 1) {
                if (v.data!.stateId != null && v.data!.cityId != null) {
                  await getCountryDetailApiCall(
                      v.data!.stateId.validate(), context);
                  await getCityDetailApiCall(
                      v.data!.cityId.validate(), context);
                } else {
                  await showDialog(
                      context: getContext,
                      builder: (_) {
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: radius(defaultRadius), color: primaryColor),
                  child: Text(language.loginAsAdmin,
