...
class _AddVehicleDialogState extends State<AddVehicleDialog> {
    ...
    if (image != null) {
      ...
      return ClipRRect(
        ...
        child: commonCachedNetworkImage(
            isUpdate
                ? widget.vehicleData!.vehicleImage.validate()
  ...
  getCityListApiCall() async {
    ...
    await getCityList(stateId: selectedCountryId).then((value) {
    ...
    if (isUpdate) {
      if (widget.vehicleData!.type == 'city_wise') {
        cityList.forEach((element) {
          cityId =
              widget.vehicleData!.cityIds!.map((e) => e.toString()).toList();
      ...
      if (widget.vehicleData!.type != null)
        vehicleType = widget.vehicleData!.type ?? 'city_wise';
  ...
  addVehicleApi() async {
    if (_formKey.currentState!.validate()) {
      ...
      log('$_cityId');
      if (isUpdate
          ? widget.vehicleData!.vehicleImage!.isNotEmpty
          : imageVehicle != null) {
        addVehicle(
          ...
          vehicleImage: isUpdate
              ? widget.vehicleData!.vehicleImage
              : imageVehicle!.path.split('/').last,
          type: vehicleType,
          ...
          toast(isUpdate
              ? language.vehicleUpdateSuccessfully
              : language.vehicleAddedSuccessfully);
          appStore.setLoading(false);
  ...
  Future<void> getImage() async {
    imageVehicle = null;
    imageVehicle = await ImagePicker()
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: Row(
        ...
        children: [
          Text(isUpdate ? language.update_vehicle : language.add_vehicle,
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(language.vehicle_capacity,
                                      style: primaryTextStyle()),
                                  SizedBox(height: 8),
                                  AppTextField(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Text(language.select_file,
