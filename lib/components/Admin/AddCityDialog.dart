...
class AddCityDialog extends StatefulWidget {
  ...
  AddCityDialog({this.regionData, this.onUpdate});
...
class AddCityDialogState extends State<AddCityDialog> {
  ...
  Future<void> init() async {
    ...
    isUpdate = widget.regionData != null;
    if (isUpdate) {
      cityNameController.text = widget.regionData!.name!;
      fixedChargeController.text = widget.regionData!.fixedCharges.toString();
      cancelChargeController.text = widget.regionData!.cancelCharges.toString();
      minDistanceController.text = widget.regionData!.minDistance.toString();
      minWeightController.text = widget.regionData!.minWeight.toString();
      perDistanceChargeController.text =
          widget.regionData!.perDistanceCharges.toString();
      perWeightChargeChargeController.text =
          widget.regionData!.perWeightCharges.toString();
      appStore.stateList.forEach((element) {
        if (element.id == widget.regionData!.stateId) {
          selectedCountryId = widget.regionData!.stateId;
        }
      });
      commissionType = widget.regionData!.commissionType.isEmptyOrNull
          ? 'fixed'
          : widget.regionData!.commissionType.toString();
      commissionController.text = widget.regionData!.adminCommission.toString();
  ...
  AddCityApi() async {
    if (_formKey.currentState!.validate()) {
      ...
      Map req = {
        "id": isUpdate ? widget.regionData!.id : "",
