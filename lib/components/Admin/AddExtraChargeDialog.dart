  ...
  Future<void> init() async {
    ...
    if (isUpdate) {
      ...
      appStore.stateList.forEach((element) {
        if (element.id == widget.extraChargesData!.stateId!) {
          selectedCountryId = widget.extraChargesData!.stateId!;
        }
      });
  ...
  addExtraChargeApiCall() async {
    if (_formKey.currentState!.validate()) {
      if (chargeTypeValue == null)
        return toast(language.please_select_charge_type);
    ...
    return AlertDialog(
      ...
      title: Row(
        ...
        children: [
          Text(
              isUpdate
                  ? language.update_extra_charge
                  : language.add_extra_charge,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<int>(
                                ...
                                decoration: commonInputDecoration(),
                                items:
                                    regionList.map<DropdownMenuItem<int>>((item) {
                                  return DropdownMenuItem(
                                      value: item.id,
                                      child: Text(item.name!,
                                          style: primaryTextStyle()));
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: RadioListTile<String>(
                            ...
                            title: Text(CHARGE_TYPE_PERCENTAGE,
                                style: primaryTextStyle()),
                            groupValue: chargeTypeValue,
                            onChanged: (value) {
                              chargeTypeValue = value;
