...
class DeliveryOrderAssignWidget extends StatefulWidget {
  ...
  DeliveryOrderAssignWidget(
      {this.onUpdate, required this.OrderId, required this.orderModel});

  @override
  DeliveryOrderAssignWidgetState createState() =>
      DeliveryOrderAssignWidgetState();
}
...
class DeliveryOrderAssignWidgetState extends State<DeliveryOrderAssignWidget> {
  ...
  getDeliveryBoyApi() async {
    await getAllDeliveryBoyList(
            type: DELIVERYMAN,
            stateId: widget.orderModel.stateId,
                                          ...
                                          DataCell(
                                            OutlinedButton(
                                              child: widget.orderModel
                                                  ...
                                                  ? Text(language.assign_order)
                                                  : Text(
                                                      language.order_transfer),
                                              onPressed: () async {
                                                if (getStringAsync(USER_TYPE) ==
                                                    DEMO_ADMIN) {
                                                  toast(
                                                      language.demo_admin_msg);
                                                } else {
