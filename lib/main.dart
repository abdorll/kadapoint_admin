...
import 'package:local_delivery_admin/screens/Admin/AdminLoginScreen.dart';
...
void main() async {
  ...
  clientStore.setFiltering(filterData.orderStatus.toString() != "null" ||
      filterData.fromDate.toString() != "null" ||
      filterData.toDate.toString() != "null");
  ...
  Widget build(BuildContext context) {
    return Observer(builder: (context) {
      return MaterialApp(
        ...
        initialRoute: AdminLoginScreen.route,
        routes: route,
