...
Route<dynamic>? onGenerateRoute(settings) {
  ...
  MaterialPageRoute clientDashboardRoute = MaterialPageRoute(
  ...
  if (settings.name ==
      OrderDetailScreen.route + "?order_Id=${queryParameters['order_Id']}") {
    return isClientLogin
        ? MaterialPageRoute(
            builder: (context) =>
                OrderDetailScreen(orderId: queryParameters['order_Id'].toInt()),
            settings: settings)
        : clientDashboardRoute;
  }
  if (settings.name ==
      SendPackageFragment.route + "?order_Id=${queryParameters['order_Id']}") {
    return isClientLogin
        ? MaterialPageRoute(
            builder: (context) => SendPackageFragment(
                orderId: queryParameters['order_Id'].toInt()),
            settings: settings)
        : clientDashboardRoute;
  }
  if (settings.name ==
      ChatScreen.route + "?user_Id=${queryParameters['user_Id']}") {
    return isClientLogin
        ? MaterialPageRoute(
            builder: (context) =>
                ChatScreen(userId: queryParameters['user_Id'].toInt()),
            settings: settings)
        : clientDashboardRoute;
  }
  if (settings.name == SendPackageFragment.route) {
    return isClientLogin
        ? MaterialPageRoute(
            builder: (context) => SendPackageFragment(), settings: settings)
        : clientDashboardRoute;
  }
  ...
  if (settings.name ==
      PaymentSetupScreen.route +
          "?payment_type=${queryParameters['payment_type']}") {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => PaymentSetupScreen(
                paymentType: queryParameters['payment_type']),
            settings: settings)
        : adminLoginRoute;
  }
  if (settings.name ==
      DeliveryPersonDocumentScreen.route +
          "?delivery_man_id=${queryParameters['delivery_man_id']}") {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => DeliveryPersonDocumentScreen(
                deliveryManId: queryParameters['delivery_man_id'].toInt()),
            settings: settings)
        : adminLoginRoute;
  }
  if (settings.name ==
      DeliveryPersonDetailScreen.route +
          "?user_Id=${queryParameters['user_Id']}") {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => DeliveryPersonDetailScreen(
                userId: queryParameters['user_Id'].toInt()),
            settings: settings)
        : adminLoginRoute;
  }
  if (settings.name ==
    ...
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => DeliveryPersonDetailScreen(
                userId: queryParameters['delivery_man_id'].toInt()),
            settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == NotificationViewAllScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => NotificationViewAllScreen(),
            settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == PaymentSetupScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => PaymentSetupScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == AdminHomeScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => AdminHomeScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == CountryScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => CountryScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == CityScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => CityScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == ExtraChargesScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => ExtraChargesScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == PackageTypeScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => PackageTypeScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == PaymentGatewayScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => PaymentGatewayScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == CreateOrderScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => CreateOrderScreen(), settings: settings)
        : adminLoginRoute;
  }
  ...
  if (settings.name == DocumentScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => DocumentScreen(), settings: settings)
        : adminLoginRoute;
  }
  ...
  if (settings.name == UsersScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => UsersScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == DeliveryBoyScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => DeliveryBoyScreen(), settings: settings)
        : adminLoginRoute;
  }
  ...
  if (settings.name == AppSettingScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => AppSettingScreen(), settings: settings)
        : adminLoginRoute;
  }
  if (settings.name == VehicleScreen.route) {
    return isAdminLogin
        ? MaterialPageRoute(
            builder: (context) => VehicleScreen(), settings: settings)
        : adminLoginRoute;
  }
  return null;
}
